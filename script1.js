...
function perSec() {
  ...
  timeHour = document.getElementById("hour").innerHTML = addZero(
    date.getHours()
  );
  timeMin = document.getElementById("min").innerHTML = addZero(
    date.getMinutes()
  );
  timeSeconds = document.getElementById("sec").innerHTML = addZero(
    date.getSeconds()
  );
